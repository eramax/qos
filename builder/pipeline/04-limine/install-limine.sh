...
root="$(repo_root)"
limine_config="${LIMINE_CONFIG:-$root/builder/pipeline/04-limine/limine.conf}"
...
limine_branch_file="${LIMINE_BRANCH_FILE:-$root/builder/pipeline/04-limine/branch}"
...
manifest_add "command: builder/pipeline/04-limine/install-limine.sh branch=$branch"
