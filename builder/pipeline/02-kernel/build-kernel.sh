...
root="$(repo_root)"
kernel_config="${KERNEL_CONFIG:-$root/components/kernel/kernel/x86_64.config}"
kernel_build_dir="${KERNEL_BUILD_DIR:-$root/build/kernel}"
kernel_version_file="${KERNEL_VERSION_FILE:-$root/components/kernel/kernel/version}"
...
manifest_add "command: builder/pipeline/02-kernel/build-kernel.sh version=$kernel_version"
